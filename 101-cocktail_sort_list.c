...
/**
 * swap_node_ahead - Swapping a node in a listint_t doubly-linked list
 ...
 * @shaker: Is a pointer to the current swap node of the cocktail shaker algo.
 */
void swap_node_ahead(listint_t **list, listint_t **tail, listint_t **shaker)
{
...
/**
 * swap_node_behind - Swapping a node in a listint_t doubly-linked
