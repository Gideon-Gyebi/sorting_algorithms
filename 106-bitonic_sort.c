 ...
 * @start: Is the starting index of the sequence in array to sort.
 * @seq: Is the size of the sequence to sort.
 * @flow: Is the direction to sort in.
 */
void bitonic_merge(int *array, size_t size, size_t start, size_t seq, char flow)
{
	size_t i, jump = seq / 2;
 ...
 * @array: Is an array of integers.
 * @size: Is the size of the array.
 * @start: Is the starting index of a block of the building bitonic sequence.
 * @seq: Is the size of a block of the building bitonic sequence.
 * @flow: Is the direction to sort the bitonic sequence block in.
 */
void bitonic_seq(int *array, size_t size, size_t start, size_t seq, char flow)
{
	size_t cut = seq / 2;
